    ...
    membersservice.getMembers(function(err, members) {
        ...
        for (var i = 0; i < members.length; i++) {
            ...
            data.push([
                members[i].lastname,
                members[i].firstname,
                members[i].email, (members[i].alias) ? members[i].alias : '', (members[i].tel) ? members[i].tel : '',
                status,
                members[i].role, (members[i].accessiondate) ? moment(members[i].accessiondate).format('DD.MM.YYYY') : '',
                honorary, (members[i].teamdrive) ? members[i].teamdrive : '',
            ]);
        }
