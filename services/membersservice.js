...
exports.getMembers = function(callback) {
    userservice.getUsers(function(err, users) {
        ...
        //desired attributes
        var attrs = ['username', 'firstname', 'lastname', 'tel', 'email', 'role', 'teamdrive', 'street', 'zip', 'city', 'former', 'honorary', 'alias', 'birthday', 'accessiondate', 'executive', 'applicant', 'superuser'];
