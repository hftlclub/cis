...
angular.module('ui.ace', [])
    ...
    .directive('uiAce', ['uiAceConfig', function(uiAceConfig) {
        ...
        var setOptions = function(acee, session, opts) {
            ...
            if (angular.isDefined(opts.showevisibles)) {
                acee.renderer.setShowevisibles(opts.showevisibles);
            }
            if (angular.isDefined(opts.showedentGuides)) {
                acee.renderer.setDisplayIndentGuides(opts.showedentGuides);
            }
